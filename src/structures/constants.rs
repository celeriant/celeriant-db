...
pub const UNCOMPRESSED_BATCH_SIZE_OFFSET: usize = EVENT_TYPE_MAJOR_OFFSET + size_of::<u64>();
pub const EVENT_TYPE_MAJOR_OFFSET: usize = BLOOM_OFFSET + size_of::<u64>();
pub const BLOOM_OFFSET: usize = LOCAL_INDEX_OFFSET + BLOOM_BYTES;
...
pub const CLIENT_ID_OFFSET: usize = TAIL_COMPRESSED_BATCH_SIZE_OFFSET + size_of::<u64>();
