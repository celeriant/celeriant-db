...
{
    public class WriteAndBackup(ILogger<WriteAndBackup> logger, IFileHandlesManager fileHandlesManager, IWriteEvents writeEvents, IOptions<ConfigurationEntry> utilityDeltaConfiguration) : IWriteAndBackup
    {
