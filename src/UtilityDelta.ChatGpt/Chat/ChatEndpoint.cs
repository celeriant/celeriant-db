...
namespace OpenAI_API.Chat
{
	...
	public class ChatEndpoint : EndpointBase, IChatEndpoint
	{
        ...
        {
            string jsonContent = System.Text.Json.JsonSerializer.Serialize(request, SourceGenerationContext.Default.ChatRequest);
            return await HttpPostChatResult(jsonContent: jsonContent);
		}
		...
		public IAsyncEnumerable<ChatResult> StreamChatEnumerableAsync(ChatRequest request)
		{
            ...
            string jsonContent = System.Text.Json.JsonSerializer.Serialize(request, SourceGenerationContext.Default.ChatRequest);
            return HttpStreamingRequest<ChatResult>(Url, HttpMethod.Post, jsonContent);
		}
