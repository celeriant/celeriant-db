...
namespace OpenAI_API.Chat
{
	...
	public class ChatRequest
	{
		...
		/// This is only used for serializing the request into JSON, do not use it directly.
		/// </summary>
		[JsonPropertyName("response_format"/*, DefaultValueHandling=DefaultValueHandling.Ignore*/)]
		...
		/// </summary>
		[JsonPropertyName("seed"/*, DefaultValueHandling=DefaultValueHandling.Ignore*/)]
