...
namespace OpenAI_API.Completions
{
	...
	public class CompletionEndpoint : EndpointBase, ICompletionEndpoint
	{
        ...
        {
            string jsonContent = System.Text.Json.JsonSerializer.Serialize(request, SourceGenerationContext.Default.CompletionRequest);
            return await HttpPost<CompletionResult>(jsonContent: jsonContent);
		}
		...
		public IAsyncEnumerable<CompletionResult> StreamCompletionEnumerableAsync(CompletionRequest request)
		{
            ...
            string jsonContent = System.Text.Json.JsonSerializer.Serialize(request, SourceGenerationContext.Default.CompletionRequest);
            return HttpStreamingRequest<CompletionResult>(Url, HttpMethod.Post, jsonContent);
		}
