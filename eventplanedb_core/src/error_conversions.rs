...
//             }
//             WriteError::EmptyEventsList { client_id } => EventPlaneDBError {
...
//                 ..Default::default()
//             },
//             WriteError::SerializationError { message: _ } => EventPlaneDBError::serialization_error(),
//             WriteError::WriteError { message: _ } => EventPlaneDBError::write_error(),
//         }
//     }
// }