...
pub static CLIENTS: LazyLock<Vec<ClientSeed>> = LazyLock::new(|| {
    vec![
        ClientSeed { name: "Machine A", id: deterministic_id("MachineA") },
        ClientSeed { name: "Machine B", id: deterministic_id("MachineB") },
    ]
});
