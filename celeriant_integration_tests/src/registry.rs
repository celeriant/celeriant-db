...
pub fn all_tests() -> &'static [TestEntry] {
    ...
    &[
        ...
        TestEntry {
            name: "not_leader_error",
            description: "NotLeader error returns leader address for client redirect",
            estimated_secs: 5,
            categories: &[Core, Election],
            distributed: true,
        },
        TestEntry {
        ...
        TestEntry {
            name: "s3_fallback",
            description: "S3 fallback when follower goes offline, data lands at correct paths",
            estimated_secs: 11,
        ...
        TestEntry {
            name: "s3_reconvergence",
            description: "Post-partition healing: cluster reconverges to exactly one leader",
            estimated_secs: 16,
            categories: &[Replication],
            distributed: true,
        },
        TestEntry {
            name: "s3_old_leader_recovery",
            description: "Old leader discovers new leader via S3 lease, rejoins as follower",
            estimated_secs: 26,
            categories: &[Replication],
            distributed: true,
        },
        ...
        TestEntry {
            name: "s3_failover",
            description: "Leader crash -> follower takeover -> old leader restarts as follower",
            estimated_secs: 16,
            categories: &[Election],
            distributed: true,
        },
        ...
        TestEntry {
            ...
            description: "Both nodes fence when S3 unreachable, retry with backoff until S3 returns",
            estimated_secs: 19,
            categories: &[Election],
            distributed: true,
        },
        ...
        TestEntry {
            name: "s3_writes_during_fencing",
            description: "No writes accepted while fenced after network partition",
            estimated_secs: 25,
            categories: &[Fencing],
            distributed: true,
        },
        TestEntry {
            ...
            description: "IfMatchETag CAS: two nodes race to S3, exactly one wins",
            estimated_secs: 23,
            categories: &[Fencing],
            distributed: true,
        },
        ...
        TestEntry {
            name: "edge_wal_divergence_recovery",
            description: "Divergent follower syncs with leader via S3 fallback",
            estimated_secs: 32,
            categories: &[Edge],
            distributed: true,
        },
        TestEntry {
            name: "edge_leader_crash_divergent_wal",
            description: "Old leader rejoins after crash, auto-heals divergent WAL from S3",
            estimated_secs: 54,
            categories: &[Edge],
            distributed: true,
        },
        ...
        TestEntry {
            name: "schema_failover",
            description: "Schema enforcement survives leader swap",
            estimated_secs: 10,
            categories: &[Schema],
            distributed: true,
        },
