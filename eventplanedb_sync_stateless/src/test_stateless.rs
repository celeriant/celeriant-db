...
mod tests {
    ...
    fn test_event_batch_file_too_short() -> io::Result<()> {
        ...
        let event_batch_file = std::fs::OpenOptions::new()
            .write(true)
    ...
    fn test_trim_end_operation() -> io::Result<()> {
        ...
        // Perform trim_end
        let mut event_batch_writer = std::fs::OpenOptions::new()
            .write(true)
            .open(fixture._temp_dir.path().join("event_batches.bin"))?;
        let mut metadata_writer = std::fs::OpenOptions::new()
            .write(true)
    ...
    fn test_delete_partial_failure() -> io::Result<()> {
        ...
        let temp_metadata_file =
            std::fs::File::create(fixture._temp_dir.path().join("temp_metadata.bin"))?;
    ...
    fn test_trim_operations_preserve_data_integrity() -> io::Result<()> {
        ...
        let temp_event_file =
            std::fs::File::create(fixture._temp_dir.path().join("temp_events.bin"))?;
        let temp_metadata_file =
            std::fs::File::create(fixture._temp_dir.path().join("temp_metadata.bin"))?;
    ...
    fn test_positions_for_event_batch_index() -> io::Result<()> {
        ...
        let (_event_batch_reader, mut metadata_reader) = fixture.create_readers()?;
