...
impl RequestType {
    pub fn from_u32(value: u32) -> Result<Self, WireError> {
        match value {
            ...
            6 => Ok(RequestType::PrependBatches),
...
pub enum Request {
    ...
    Read(ReadRequest),
    Write(WriteRequest),
    PrependBatches(PrependBatchesRequest),
...
impl Request {
    pub fn request_type(&self) -> RequestType {
        match self {
            ...
            Request::PrependBatches(_) => RequestType::PrependBatches,
        ...
        R: AsyncReadExt + Unpin,
    {
        ...
        let request = if request_type.is_fixed_size() {
            ...
            match request_type {
                ...
                RequestType::PrependBatches => Request::PrependBatches(
                    wire_header
                        .read_variable_size(reader, max_request_size)
                        .await?,
                ),
...
mod tests {
    ...
    fn make_test_request(request_type: RequestType) -> Request {
        ...
        match request_type {
            ...
            RequestType::PrependBatches => Request::PrependBatches(PrependBatchesRequest {
