...
| `PrependBatches` | Prepend historical batches (restore) | No |
| `UpdateCacheLimits` | Adjust server cache settings | Yes |
...
| `PrependBatches` | Success acknowledgement | Yes |
| `UpdateCacheLimits` | Success acknowledgement | Yes |
