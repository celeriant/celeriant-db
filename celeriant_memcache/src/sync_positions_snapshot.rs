use celeriant_wal::precomputed_hash::{PrecomputedMap, PrecomputedSet};
...
pub struct SyncPositionsSnapshot {
    ...
    pub aggregate_queue_positions: PrecomputedMap<AggregateKey, QueueAggregatePositions>,
    pub pending_schema_registrations: PrecomputedSet<SchemaKey>,
}
